...
idtreat <- data.frame(sensorid=c(94202093,94202100,94202096,94202098,94202094,94202095,94202092,94202099,94202091),treat=c('Grass','Grass','Wall','Wall','Palm','Palm','Bushes','Bushes','Air'))
```
...
abline(v=62+0:1000*96,col="grey",lty=1)
abline(v=14+0:1000*96,col="darkgoldenrod",lty=2)
legend("topright",legend=c("Grass","Palm under.","Colgado","Bushes","Wall"),col=c("forestgreen","dodgerblue","red","darkgoldenrod4","darkorchid"),lty=1,bty="n",cex=0.7)
...
plot(dt[dt$Sensor=="94202093",]$ID,dt[dt$Sensor=="94202093",]$Temp1,type="l",col="red",ylab="Temperature",xlab="ID")
...
plot(dt[dt$Sensor=="94202096",]$ID,dt[dt$Sensor=="94202096",]$Temp1,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Palm
plot(dt[dt$Sensor=="94202094",]$ID,dt[dt$Sensor=="94202094",]$Temp1,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Bushes
plot(dt[dt$Sensor=="94202092",]$ID,dt[dt$Sensor=="94202092",]$Temp1,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Grass
plot(dt[dt$Sensor=="94202093",]$ID,dt[dt$Sensor=="94202093",]$Temp2,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Wall
plot(dt[dt$Sensor=="94202096",]$ID,dt[dt$Sensor=="94202096",]$Temp2,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Palm
plot(dt[dt$Sensor=="94202094",]$ID,dt[dt$Sensor=="94202094",]$Temp2,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Bushes
plot(dt[dt$Sensor=="94202092",]$ID,dt[dt$Sensor=="94202092",]$Temp2,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Grass
plot(dt[dt$Sensor=="94202093",]$ID,dt[dt$Sensor=="94202093",]$Temp3,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Wall
plot(dt[dt$Sensor=="94202096",]$ID,dt[dt$Sensor=="94202096",]$Temp3,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Palm
plot(dt[dt$Sensor=="94202094",]$ID,dt[dt$Sensor=="94202094",]$Temp3,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Bushes
plot(dt[dt$Sensor=="94202092",]$ID,dt[dt$Sensor=="94202092",]$Temp3,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Grass
plot(dt[dt$Sensor=="94202093",]$ID,dt[dt$Sensor=="94202093",]$SoilMoisture,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Wall
plot(dt[dt$Sensor=="94202096",]$ID,dt[dt$Sensor=="94202096",]$SoilMoisture,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Palm
plot(dt[dt$Sensor=="94202094",]$ID,dt[dt$Sensor=="94202094",]$SoilMoisture,type="l",col="red",ylab="Temperature",xlab="ID")
...
```{r,echo=FALSE}
##Bushes
plot(dt[dt$Sensor=="94202092",]$ID,dt[dt$Sensor=="94202092",]$SoilMoisture,type="l",col="red",ylab="Temperature",xlab="ID")
