...
Here are basic graphics the difference in measurements between dataloggers and the difference between temperature 1, 2 and 3 (*i.e.*, soil, ground and aboveground).
...
## Soil, middle and top temperature by each datalogger
...
## Measurements between experimental treatments {.tabset}
...
## Top temperature between dataloggers in the same treatment {.tabset}
